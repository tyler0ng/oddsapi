...
```bash
ssh -i ~/oracle_key opc@<PUBLIC_IP>
...
DB_PATH=/home/opc/odds-tracker/odds_tracker.db
EOF
```
...
Type=simple
User=opc
WorkingDirectory=/home/opc/odds-tracker
EnvironmentFile=/home/opc/odds-tracker/.env
ExecStart=/home/opc/odds-tracker/venv/bin/python scheduler.py
Restart=always
RestartSec=30
